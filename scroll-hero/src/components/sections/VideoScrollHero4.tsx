...
export default function VideoScrollHero4() {
  ...
  useEffect(() => {
    ...
    for (let i = 1; i <= FRAME_COUNT; i++) {
      ...
      img.src = `/frames4/frame_${frameNum}.jpg`;
    ...
    <>
      ...
      <section ref={sectionRef} className="scroll-section relative">
        <div className="sticky top-0 h-screen overflow-hidden">
          ...
          >
            <div className="flex flex-col items-center gap-6 max-w-2xl">
              ...
              <p
                ...
                style={{ color: "var(--muted)" }}
              >
                "It's not like I wanted you to scroll, or anything!" Feel the tsundere sparks in this beautiful profile outline.
              </p>
          ...
          >
            ...
            <span className="text-[9px] tracking-widest">V.04 — Tsundere Spark</span>
          </div>
      ...
      >
        ...
        <div className="relative z-10 flex flex-col items-center gap-6 max-w-xl">
          ...
          >
            The tsundere shield<br />has been broken.
          </h2>
          <p
            className="text-sm md:text-base leading-relaxed"
            style={{ color: "var(--muted)" }}
          >
            Keep scrolling to meet Shizuka Yoshimoto.
          </p>
