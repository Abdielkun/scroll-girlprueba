...
export default function VideoScrollHero6() {
  ...
  useEffect(() => {
    ...
    for (let i = 1; i <= FRAME_COUNT; i++) {
      ...
      img.src = `/frames6/frame_${frameNum}.jpg`;
    ...
    <>
      ...
      <section ref={sectionRef} className="scroll-section relative">
        <div className="sticky top-0 h-screen overflow-hidden">
          ...
          >
            <div className="flex flex-col items-center gap-6 max-w-2xl">
              ...
              <p
                ...
                style={{ color: "var(--muted)" }}
              >
                The final chapter of Shizuka. Watch her gentle profile reading on her smartphone, glowing softly in peaceful blue outlines.
              </p>
          ...
          >
            ...
            <span className="text-[9px] tracking-widest">V.06 — Quiet Melodies</span>
          </div>
      ...
      >
        ...
        <div className="relative z-10 flex flex-col items-center gap-6 max-w-xl">
          ...
          >
            The silent story<br />is complete.
          </h2>
          <p
            className="text-sm md:text-base leading-relaxed"
            style={{ color: "var(--muted)" }}
          >
            Thank you for exploring this gorgeous iridescent sequence.
          </p>
