...
export default function VideoScrollHero5() {
  ...
  useEffect(() => {
    ...
    for (let i = 1; i <= FRAME_COUNT; i++) {
      ...
      img.src = `/frames5/frame_${frameNum}.jpg`;
    ...
    <>
      ...
      <section ref={sectionRef} className="scroll-section relative">
        <div className="sticky top-0 h-screen overflow-hidden">
          ...
          >
            <div className="flex flex-col items-center gap-6 max-w-2xl">
              ...
              <p
                ...
                style={{ color: "var(--muted)" }}
              >
                The quiet, lovable bibliophile. Witness her gentle outline stretching out to connect in this gorgeous high-definition figure render.
              </p>
          ...
          >
            ...
            <span className="text-[9px] tracking-widest">V.05 — Silent Reader</span>
          </div>
      ...
      >
        ...
        <div className="relative z-10 flex flex-col items-center gap-6 max-w-xl">
          ...
          >
            The silent story<br />has begun.
          </h2>
          <p
            className="text-sm md:text-base leading-relaxed"
            style={{ color: "var(--muted)" }}
          >
            Scroll further for the final segment of Shizuka.
          </p>
